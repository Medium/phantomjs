...
PhantomJsServer.prototype.running = function () {
...
exports.start = function (callback) {
  ...
  if (callback) {
    var waitForServerRunning = function (data) {
      // NOTE: although we call .removeListener, we might receive more data in the meantime
      // This conditional check prevents callback from getting called more than once
